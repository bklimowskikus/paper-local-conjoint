...
format:
  html:
    ...
    comments:
      hypothesis: true
  pdf:
      pandoc-args: ["-M", "critic-mode=edited"]
---
...
{--@fig-heterogeneity compares place-based and government-alignment cues among clearly pro- and anti-government profiles and respondents. Column A shows the local bonus within aligned and non-aligned pairs. Column B shows the alignment bonus within each municipal-connection level. The upper row reports marginal means; the lower row reports their differences.--}{++@fig-heterogeneity compares place-based and government-alignment cues among clearly pro- and anti-government profiles and respondents. The top panel displays marginal means across municipal-connection levels for aligned and non-aligned pairs. The lower-left panel shows resident--outsider differences within each alignment group; the lower-right panel shows aligned--non-aligned differences within each municipal-connection level.++}
